...
const HeroAntu = () => {
  ...
  const heroContent = isNight ? {
    ...
    description: "Bajo el manto estelar, el territorio andino devela su astroteología ancestral. Conéctate con sabios de la comunidad en fogones nocturnos, participa en foros de astroturismo y planifica tus pernoctaciones místicas.",
    ...
    : {
      ...
      description: "Durante el día, la Araucanía vibra con volcanes imponentes, senderos sagrados custodiados por Araucarias milenarias y lagos de agua de deshielo. Explora la cartografía cultural interactiva de nuestra comunidad.",
	...
	"
        >
          ...
          <div className="max-w-[800px]">
            <p
              className={`
			mb-5 font-mono text-sm tracking-[0.08em]
			${isNight ? "text-amber-400" : "text-orange-400"}
		`}
            >
              {heroContent.quote}
            </p>
		...
		"
          ...
          {/* Right celestial selector */}
          <div className="w-full lg:max-w-[390px]">
            {/* Celestial selector separator */}
            <div className="mb-5">
            ...
            <div className="grid grid-cols-2 rounded-full border border-indigo-500/20 bg-[#050713]/90 p-1 shadow-[inset_0_0_20px_rgba(0,0,0,0.25)] backdrop-blur-xl">
              <button
                ...
                className={`flex items-center justify-center gap-2 rounded-full px-4 py-2 text-xs font-semibold transition-all duration-300
									${!isNight ? `bg-orange-500 text-white` : `text-slate-400 hover:text-white`}`}
              >
                <Sun size={15} />
                Día (Antü)
              </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-300">
                ...
                (Luna Creciente) — Excelente
                para caminatas reflexivas y
