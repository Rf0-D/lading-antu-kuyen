...
const HeaderAntu = () => {
	...
	/*
	 * Por ahora solo define el contexto visual.
	 *
	 * Después podemos usar esto también para decidir
	 * qué endpoint / fuente consultar.
	 */
		...
		: pathname.startsWith("/experiences")
			...
			: pathname.startsWith("/comunities")
				...
				: {
						...
						placeholder:
							"Buscar destinos, experiencias o comunidades...",
					};
			...
			>
				...
				>
					...
					>
						{/* ================================================= */}
						{/* MOBILE LEFT SPACER */}
						{/* Mantiene el logo perfectamente centrado */}
						{/* ================================================= */}
							...
							>
								{search.trim() ? (
									<div>
										...
										{/* ================================= */}
										{/* Aquí conectaremos resultados reales */}
										{/* ================================= */}
